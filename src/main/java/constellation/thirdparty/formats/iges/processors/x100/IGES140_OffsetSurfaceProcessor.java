...
/** 
 * Represents an IGES Offset Surface
 * @author lawrence.daniels@gmail.com
 */
public class IGES140_OffsetSurfaceProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Offset Surface: params = %s", params.toString() ) );
