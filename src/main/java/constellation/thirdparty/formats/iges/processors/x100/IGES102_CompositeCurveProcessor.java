...
/** 
 * Represents an IGES Composite Curve
 * @author lawrence.daniels@gmail.com
 */
public class IGES102_CompositeCurveProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Composite Curve: params = %s", params.toString() ) );
