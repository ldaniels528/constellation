...
/** 
 * Represents an IGES Rule Surface
 * @author lawrence.daniels@gmail.com
 */
public class IGES118_RuleSurfaceProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Rule Surface: params = %s", params.toString() ) );
