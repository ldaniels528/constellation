...
/** 
 * Represents an IGES Nodal Results
 * @author lawrence.daniels@gmail.com
 */
public class IGES146_NodalResultsProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Nodal Results: params = %s", params.toString() ) );
