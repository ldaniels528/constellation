...
/** 
 * Represents an IGES Rational B-Spline Surface
 * @author lawrence.daniels@gmail.com
 */
public class IGES128_RationalBSplineSurfaceProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Rational B-Spline Surface: params = %s", params.toString() ) );
