...
/** 
 * Represents an IGES Finite Element
 * @author lawrence.daniels@gmail.com
 */
public class IGES136_FiniteElementProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Finite Element: params = %s", params.toString() ) );
