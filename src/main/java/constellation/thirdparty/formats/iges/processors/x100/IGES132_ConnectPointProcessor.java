...
/** 
 * Represents an IGES Connect Point
 * @author lawrence.daniels@gmail.com
 */
public class IGES132_ConnectPointProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Connect Point: params = %s", params.toString() ) );
