...
/** 
 * Represents an IGES Flag Note
 * @author lawrence.daniels@gmail.com
 */
public class IGES208_FlagNoteProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Flag Note: params = %s", params.toString() ) );
