...
/** 
 * Represents an IGES Curve Dimension
 * @author lawrence.daniels@gmail.com
 */
public class IGES204_CurveDimensionProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Curve Dimension: params = %s", params.toString() ) );
