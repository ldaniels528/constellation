...
/** 
 * Represents an IGES Offset Curve
 * @author lawrence.daniels@gmail.com
 */
public class IGES130_OffsetCurveProcessor extends IGESAbstractEntityProcessor {
	...
	throws ModelFormatException {
		logger.info( String.format( "Offset Curve: params = %s", params.toString() ) );
