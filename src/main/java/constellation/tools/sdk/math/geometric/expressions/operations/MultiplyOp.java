...
/**
 * Represents an Multiplication operation
 * @author lawrence.daniels@gmail.com
 */
public class MultiplyOp implements ValueReference {
	 ...
	 */
	public MultiplyOp( final ValueReference lvar, final ValueReference rvar ) {
		this.lvar 	= lvar;
		this.rvar	= rvar;
	}
